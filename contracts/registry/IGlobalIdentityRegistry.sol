...
interface IGlobalIdentityRegistry {
     ...
     */
    event ClaimTopicsRegistrySet(address indexed token, address indexed claimTopicsRegistry);
     ...
     *  `_claimTopicsRegistry` is the address of the Claim Topics Registry contract
     */
    event TrustedIssuersRegistrySet(address indexed token, address indexed trustedIssuersRegistry);
    ...
    */
    function setClaimTopicsRegistry(address _token, address _claimTopicsRegistry) external;
    ...
    */
    function setTrustedIssuersRegistry(address _token, address _trustedIssuersRegistry) external;
    ...
    */
     ...
     */
    function issuersRegistry(address _token) external view returns (ITrustedIssuersRegistry);

    /**
     *  @dev Returns the ClaimTopicsRegistry linked to the current IdentityRegistry.
     */
    function topicsRegistry(address _token) external view returns (IClaimTopicsRegistry);
