...
contract InterfaceIdCalculator {
   ...
   */
  function getIERC3643IdentityRegistryInterfaceId()
    external
    pure
    returns (bytes4)
  {
   ...
   */
  function getIERC3643IdentityRegistryStorageInterfaceId()
    external
    pure
    returns (bytes4)
  {
   ...
   */
  function getIERC3643TrustedIssuersRegistryInterfaceId()
    external
    pure
    returns (bytes4)
  {
   ...
   */
  function getITREXImplementationAuthorityInterfaceId()
    external
    pure
    returns (bytes4)
  {
