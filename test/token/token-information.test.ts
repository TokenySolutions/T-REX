...
describe("Token - Information", () => {
    ...
    describe("when the caller is the owner", () => {
      describe("when the name is empty", () => {
        it("should revert", async () => {
          ...
          await expect(token.setName("")).to.be.revertedWithCustomError(
            token,
            "EmptyString"
          );
        });
    ...
    describe("when the caller is the owner", () => {
      describe("when the symbol is empty", () => {
        it("should revert", async () => {
          ...
          await expect(token.setSymbol("")).to.be.revertedWithCustomError(
            token,
            "EmptyString"
          );
        });
  ...
  describe(".pause()", () => {
    describe("when the caller is not an agent", () => {
      it("should revert", async () => {
        ...
        await expect(
          token.connect(anotherWallet).pause()
    ...
    describe("when agent permission is restricted", () => {
      it("should revert", async () => {
        ...
        await expect(
          token.connect(tokenAgent).pause()
  ...
  describe(".unpause()", () => {
    describe("when the caller is not an agent", () => {
      it("should revert", async () => {
        ...
        await expect(
          token.connect(anotherWallet).unpause()
        ).to.be.revertedWithCustomError(token, "CallerDoesNotHaveAgentRole");
      });
    });
    ...
    describe("when agent permission is restricted", () => {
      it("should revert", async () => {
        ...
        await expect(
          token.connect(tokenAgent).unpause()
        ).to.be.revertedWithCustomError(token, "AgentNotAuthorized");
      });
    });
  ...
  describe(".supportsInterface()", () => {
    it("should return false for unsupported interfaces", async () => {
      ...
      expect(await token.supportsInterface(unsupportedInterfaceId)).to.equal(
        false
      );
    });
    ...
    it("should correctly identify the IERC20 interface ID", async () => {
      ...
      const ierc20InterfaceId =
        await interfaceIdCalculator.getIERC20InterfaceId();
    ...
    it("should correctly identify the IToken interface ID", async () => {
      ...
      const iTokenInterfaceId =
        await interfaceIdCalculator.getITokenInterfaceId();
    ...
    it("should correctly identify the IERC3643 interface ID", async () => {
      ...
      const iErc3643InterfaceId =
        await interfaceIdCalculator.getIERC3643InterfaceId();
    ...
    it("should correctly identify the IERC20Permit interface ID", async () => {
      ...
      const ierc20PermitInterfaceId =
        await interfaceIdCalculator.getIERC20PermitInterfaceId();
      expect(await token.supportsInterface(ierc20PermitInterfaceId)).to.equal(
        true
      );
    });
  });
