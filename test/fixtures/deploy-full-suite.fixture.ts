...
export async function deployFullSuiteFixture() {
  ...
  await (identityFactory.connect(deployer) as IIdFactory).addTokenFactory(
    trexFactory.target
  );
  ...
  const claimTopicsRegistry = await ethers
    ...
    .then(async proxy =>
      ethers.getContractAt("ClaimTopicsRegistry", proxy.target)
    );
  const trustedIssuersRegistry = await ethers
    ...
    .then(async proxy =>
      ethers.getContractAt("TrustedIssuersRegistry", proxy.target)
    );
  const identityRegistryStorage = await ethers
    ...
    .then(async proxy =>
      ethers.getContractAt("IdentityRegistryStorage", proxy.target)
    );
  ...
  const identityRegistry = await ethers
    ...
    .then(async proxy =>
      ethers.getContractAt("IdentityRegistry", proxy.target)
    );
  ...
  await identityRegistryStorage
    .connect(deployer)
    .bindIdentityRegistry(identityRegistry.target);
  ...
  await trustedIssuersRegistry
    .connect(deployer)
    .addTrustedIssuer(claimIssuerContract.target, claimTopics);
...
export async function deploySuiteWithModularCompliancesFixture() {
  ...
  await context.suite.token
    ...
    .setCompliance(compliance.target);
