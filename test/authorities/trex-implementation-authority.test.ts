        ...
        describe("When the trex factory to add is not using this authority contract", () => {
          it("Should revert for invalid link between the factory and the authority", async () => {
            ...
            const contractsStruct = {
              ...
              ctrImplementation:
                implementations.claimTopicsRegistryImplementation.address,
              irImplementation:
                implementations.identityRegistryImplementation.address,
              irsImplementation:
                implementations.identityRegistryStorageImplementation.address,
              tirImplementation:
        ...
        describe("when version used by the reference contract is not the same as currently deployed implementations", () => {
          it("should revert", async () => {
            ...
            await otherTrexImplementationAuthority.addAndUseTREXVersion(
              ...
              {
                tokenImplementation:
                  implementations.tokenImplementation.address,
                ctrImplementation:
                  implementations.claimTopicsRegistryImplementation.address,
                irImplementation:
                  implementations.identityRegistryImplementation.address,
