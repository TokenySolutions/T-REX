...
async function deployMaxBalanceFullSuite() {
  ...
  await context.suite.token
    ...
    .burn(context.accounts.aliceWallet.address, 1000);
  await context.suite.token
    .connect(context.accounts.tokenAgent)
    .burn(context.accounts.bobWallet.address, 500);
...
describe("Compliance Module: MaxBalance", () => {
  it("should deploy the MaxBalance contract and bind it to the compliance", async () => {
    ...
    expect(
      await context.suite.compliance.isModuleBound(
  ...
  describe(".name", () => {
    it("should return the name of the module", async () => {
      ...
      expect(await context.suite.complianceModule.name()).to.be.equal(
        "MaxBalanceModule"
      );
    });
  });
    ...
    describe("when token totalSupply is greater than zero", () => {
      describe("when compliance preset status is false", () => {
        it("should return false", async () => {
          ...
          expect(
            await complianceModule.canComplianceBind(
  ...
  describe(".setMaxBalance", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.setMaxBalance(100)
    ...
    describe("when calling via compliance", () => {
      it("should set max balance", async () => {
        ...
        const tx = await context.suite.compliance.callModuleFunction(
          ...
          ]).encodeFunctionData("setMaxBalance", [100]),
          context.suite.complianceModule.target
        );

        await expect(tx)
          .to.emit(context.suite.complianceModule, "MaxBalanceSet")
          .withArgs(context.suite.compliance.target, 100);
      });
    });
  });
  ...
  describe(".owner", () => {
    it("should return owner", async () => {
      const context = await loadFixture(deployMaxBalanceFullSuite);
      await expect(context.suite.complianceModule.owner()).to.eventually.be.eq(
  ...
  describe(".initialize", () => {
    it("should be called only once", async () => {
      ...
      const module = (await ethers.deployContract("MaxBalanceModule")).connect(
        deployer
      );
  ...
  describe(".transferOwnership", () => {
    ...
    describe("when calling with owner account", () => {
      it("should transfer ownership", async () => {
        ...
        // when
        const tx1 = await context.suite.complianceModule
          .connect(context.accounts.deployer)
          .transferOwnership(context.accounts.bobWallet.address);
        expect(tx1)
        ...
        const tx2 = await context.suite.complianceModule
    ...
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule
            .connect(context.accounts.aliceWallet)
            .presetCompleted(context.suite.compliance.target)
        ).to.be.revertedWithCustomError(
          context.suite.complianceModule,
          `OnlyComplianceOwnerCanCall`
        );
      ...
      describe("when _id array is empty", () => {
        it("should revert", async () => {
          ...
          await expect(
            context.suite.complianceModule
              .connect(context.accounts.deployer)
              .batchPreSetModuleState(context.suite.compliance.target, [], [])
          ).to.be.revertedWithCustomError(
            context.suite.complianceModule,
            `InvalidPresetValues`
          );
  ...
  describe(".moduleTransferAction", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.moduleTransferAction(from, to, 10)
        ).to.revertedWithCustomError(
          context.suite.complianceModule,
          "OnlyBoundComplianceCanCall"
        );
    ...
    describe("when calling via compliance", () => {
      describe("when value exceeds the max balance", () => {
        it("should revert", async () => {
          ...
          await context.suite.compliance.callModuleFunction(
            new ethers.Interface([
              "function setMaxBalance(uint256 _max)",
            ]).encodeFunctionData("setMaxBalance", [150]),
            context.suite.complianceModule.target
          );
          ...
          await context.suite.compliance.callModuleFunction(
            ...
            ]).encodeFunctionData("moduleMintAction", [from, 150]),
            context.suite.complianceModule.target
          );
          ...
          await context.suite.compliance.callModuleFunction(
            ...
            ]).encodeFunctionData("moduleTransferAction", [from, to, 40]),
            context.suite.complianceModule.target
          );
      ...
      describe("when value does not exceed the max balance", () => {
        it("should update receiver and sender balances", async () => {
          ...
          const from = context.accounts.aliceWallet.address;
          const to = context.accounts.bobWallet.address;
          const senderIdentity = await context.suite.identityRegistry.identity(
            context.accounts.aliceWallet.address
          );
          const receiverIdentity =
            await context.suite.identityRegistry.identity(
              context.accounts.bobWallet.address
            );
          ...
          await context.suite.compliance.callModuleFunction(
            new ethers.Interface([
              "function moduleTransferAction(address _from, address _to, uint256 _value)",
            ]).encodeFunctionData("moduleTransferAction", [from, to, 120]),
            context.suite.complianceModule.target
          );

          const senderBalance =
            await context.suite.complianceModule.getIDBalance(
              context.suite.compliance.target,
              senderIdentity
            );
  ...
  describe(".moduleMintAction", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.moduleMintAction(to, 10)
        ).to.revertedWithCustomError(
          context.suite.complianceModule,
          "OnlyBoundComplianceCanCall"
        );
        ...
        it("should revert", async () => {
          ...
          await expect(
            context.suite.compliance.callModuleFunction(
              new ethers.Interface([
                "function moduleMintAction(address _to, uint256 _value)",
              ]).encodeFunctionData("moduleMintAction", [to, 160]),
              context.suite.complianceModule.target
            )
          ).to.be.revertedWithCustomError(
            context.suite.complianceModule,
      ...
      describe("when value does not exceed the max balance", () => {
        it("should update minter balance", async () => {
          ...
          await context.suite.compliance.callModuleFunction(
            new ethers.Interface([
              "function moduleMintAction(address _to, uint256 _value)",
            ]).encodeFunctionData("moduleMintAction", [to, 150]),
            context.suite.complianceModule.target
          );
  ...
  describe(".moduleBurnAction", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.moduleBurnAction(from, 10)
        ).to.revertedWithCustomError(
          context.suite.complianceModule,
          "OnlyBoundComplianceCanCall"
        );
    ...
    describe("when calling via compliance", () => {
      it("should update sender balance", async () => {
        ...
        await context.suite.compliance.callModuleFunction(
          new ethers.Interface([
            "function moduleMintAction(address _to, uint256 _value)",
          ]).encodeFunctionData("moduleMintAction", [from, 100]),
          context.suite.complianceModule.target
        );
        ...
        await context.suite.compliance.callModuleFunction(
          ...
          ]).encodeFunctionData("moduleBurnAction", [from, 90]),
          context.suite.complianceModule.target
        );

        const senderBalance = await context.suite.complianceModule.getIDBalance(
          context.suite.compliance.target,
          senderIdentity
        );
  ...
  describe(".moduleCheck", () => {
    describe("when identity not found", () => {
      it("should return false", async () => {
        ...
        await expect(
          context.suite.complianceModule.moduleCheck(
            from,
            to,
            10,
            context.suite.compliance.target
    ...
    describe("when user balance exceeds compliance max balance", () => {
      it("should return false", async () => {
        ...
        await context.suite.compliance.callModuleFunction(
          new ethers.Interface([
            "function moduleMintAction(address _to, uint256 _value)",
          ]).encodeFunctionData("moduleMintAction", [to, 100]),
          context.suite.complianceModule.target
        );
  ...
  describe(".supportsInterface()", () => {
    it("should return false for unsupported interfaces", async () => {
      ...
      expect(
        await context.suite.complianceModule.supportsInterface(
