...
describe("Compliance Module: TransferRestrict", () => {
  ...
  describe(".allowUser", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.allowUser(
  ...
  describe(".batchAllowUsers", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.batchAllowUsers([
            context.accounts.aliceWallet.address,
          ])
        ).to.revertedWithCustomError(
          context.suite.complianceModule,
    ...
    describe("when calling via compliance", () => {
      it("should allow identities", async () => {
        ...
        const tx = await context.suite.compliance.callModuleFunction(
          new ethers.Interface([
            "function batchAllowUsers(address[] _identities)",
          ]).encodeFunctionData("batchAllowUsers", [
            [
              context.accounts.aliceWallet.address,
              context.accounts.bobWallet.address,
            ],
  ...
  describe(".disallowUser", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.disallowUser(
            context.accounts.aliceWallet.address
          )
        ).to.revertedWithCustomError(
          context.suite.complianceModule,
    ...
    describe("when calling via compliance", () => {
      it("should disallow user", async () => {
        ...
        const tx = await context.suite.compliance.callModuleFunction(
          ...
          ]).encodeFunctionData("disallowUser", [
            context.accounts.aliceWallet.address,
          ]),
          context.suite.complianceModule.target
        );
  ...
  describe(".batchDisallowUsers", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.batchDisallowUsers([
            context.accounts.aliceWallet.address,
          ])
        ).to.revertedWithCustomError(
          context.suite.complianceModule,
    ...
    describe("when calling via compliance", () => {
      it("should disallow user", async () => {
        ...
        const tx = await context.suite.compliance.callModuleFunction(
          new ethers.Interface([
            "function batchDisallowUsers(address[] _identities)",
          ]).encodeFunctionData("batchDisallowUsers", [
            [
              context.accounts.aliceWallet.address,
              context.accounts.bobWallet.address,
            ],
    ...
    describe("when sender is allowed", () => {
      it("should return true", async () => {
        ...
        await context.suite.compliance.callModuleFunction(
          new ethers.Interface([
            "function allowUser(address _userAddress)",
          ]).encodeFunctionData("allowUser", [from]),
          context.suite.complianceModule.target
        );
    ...
    describe("when receiver is allowed", () => {
      it("should return true", async () => {
        ...
        await context.suite.compliance.callModuleFunction(
          new ethers.Interface([
            "function allowUser(address _userAddress)",
          ]).encodeFunctionData("allowUser", [to]),
          context.suite.complianceModule.target
        );
  ...
  describe(".unbindCompliance()", () => {
    it("should unbind the compliance", async () => {
      ...
      expect(
        await module.isUserAllowed(compliance.target, aliceWallet.address)
      ).to.be.equal(false);
      expect(
        await module.isUserAllowed(compliance.target, bobWallet.address)
      ).to.be.equal(false);
    });
  });
});
