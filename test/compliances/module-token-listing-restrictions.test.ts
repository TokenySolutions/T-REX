...
describe("Compliance Module: TokenListingRestrictions", () => {
  ...
  describe(".name", () => {
    it("should return the name of the module", async () => {
      const context = await loadFixture(
        deployTokenListingRestrictionsFullSuite
      );
  ...
  describe(".canComplianceBind", () => {
    it("should return true", async () => {
      ...
      const complianceModule = await ethers.deployContract(
        "TokenListingRestrictionsModule"
      );
      expect(
  ...
  describe(".initialize", () => {
    it("should be called only once", async () => {
      ...
      const module = (
        await ethers.deployContract("TokenListingRestrictionsModule")
      ).connect(deployer);
  ...
  describe(".configureToken", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.configureToken(1)
        ).to.revertedWithCustomError(
          context.suite.complianceModule,
    ...
    describe("when calling via compliance", () => {
          ...
          await expect(
            context.suite.compliance.callModuleFunction(
              new ethers.Interface([
                "function configureToken(uint8 _listingType)",
              ]).encodeFunctionData("configureToken", [0]),
              context.suite.complianceModule.target
            )
          ).to.be.revertedWithCustomError(
            context.suite.complianceModule,
            `InvalidListingTypeForConfiguration`
          );
        });
      });
      ...
      describe("when token is already configured", () => {
        it("should revert", async () => {
          ...
          await context.suite.compliance.callModuleFunction(
            new ethers.Interface([
              "function configureToken(uint8 _listingType)",
            ]).encodeFunctionData("configureToken", [1]),
            context.suite.complianceModule.target
          );
          ...
          await expect(
            context.suite.compliance.callModuleFunction(
              new ethers.Interface([
                "function configureToken(uint8 _listingType)",
              ]).encodeFunctionData("configureToken", [2]),
              context.suite.complianceModule.target
            )
          ).to.be.revertedWithCustomError(
            context.suite.complianceModule,
      ...
      describe("when token is not configured before", () => {
        it("should configure the token", async () => {
          ...
          await expect(tx)
            .to.emit(context.suite.complianceModule, "TokenListingConfigured")
            .withArgs(context.suite.token.target, 1);
        });
      });
    });
  });
    ...
    describe("when token is not configured", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule
            .connect(context.accounts.aliceWallet)
            .listToken(context.suite.token.target, 1)
        ).to.be.revertedWithCustomError(
          context.suite.complianceModule,
          `TokenIsNotConfigured`
        );
      });
    });
        ...
        describe("when the investor address type is WALLET", () => {
          it("should list the token", async () => {
            ...
            const tx = await context.suite.complianceModule
              .connect(context.accounts.aliceWallet)
              .listToken(context.suite.token.target, 0);
          ...
          describe("when identity exists", () => {
            it("should list the token", async () => {
              ...
              await expect(tx)
                ...
                .withArgs(
                  context.suite.token.target,
                  context.identities.aliceIdentity.target
                );
            });
          });
        });
    ...
    describe("when token is not configured", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule
            .connect(context.accounts.aliceWallet)
            .batchListTokens([context.suite.token.target], 1)
        ).to.be.revertedWithCustomError(
          context.suite.complianceModule,
          `TokenIsNotConfigured`
        );
      ...
      describe("when token is not already listed", () => {
        describe("when the investor address type is WALLET", () => {
          it("should list tokens", async () => {
            ...
            const tx = await context.suite.complianceModule
              .connect(context.accounts.aliceWallet)
              .batchListTokens([context.suite.token.target], 0);
    ...
    describe("when token is not listed", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule
            .connect(context.accounts.aliceWallet)
            .unlistToken(context.suite.token.target, 1)
        ).to.be.revertedWithCustomError(
          context.suite.complianceModule,
          `TokenIsNotListed`
        );
    ...
    describe("when token is listed", () => {
      describe("when the investor address type is WALLET", () => {
        it("should unlist the token", async () => {
          ...
          const tx = await context.suite.complianceModule
            .connect(context.accounts.aliceWallet)
            .unlistToken(context.suite.token.target, 0);
    ...
    describe("when token is not listed", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule
            .connect(context.accounts.aliceWallet)
            .batchUnlistTokens([context.suite.token.target], 1)
        ).to.be.revertedWithCustomError(
          context.suite.complianceModule,
          `TokenIsNotListed`
        );
    ...
    describe("when token is not listed", () => {
      describe("when the investor address type is WALLET", () => {
        it("should unlist tokens", async () => {
          ...
          const tx = await context.suite.complianceModule
            .connect(context.accounts.aliceWallet)
            .batchUnlistTokens([context.suite.token.target], 0);
  ...
  describe(".getTokenListingType", () => {
    describe("when token is not configured", () => {
      it("should return NOT_CONFIGURED(0)", async () => {
        ...
        const result = await context.suite.complianceModule.getTokenListingType(
          context.suite.token.target
        );
  ...
  describe(".getInvestorListingStatus", () => {
    describe("when token is not listed", () => {
      it("should return false", async () => {
        ...
        const result =
          await context.suite.complianceModule.getInvestorListingStatus(
            context.suite.token.target,
            context.accounts.aliceWallet.address
          );
  ...
  describe(".moduleMintAction", () => {
    describe("when calling from a random wallet", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.moduleMintAction(
  ...
  describe(".moduleBurnAction", () => {
    describe("when calling from a random wallet", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.suite.complianceModule.moduleBurnAction(
            context.accounts.anotherWallet.address,
            10
          )
        ).to.be.revertedWithCustomError(
  ...
  describe(".unbindCompliance()", () => {
    it("should unbind the compliance", async () => {
      const {
        ...
        accounts: { deployer },
      } = await loadFixture(deployTokenListingRestrictionsFullSuite);
