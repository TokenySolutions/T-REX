...
describe("CountryRestrictModule", () => {
  ...
  describe(".name()", () => {
    it("should return the name of the module", async () => {
      ...
      expect(await countryRestrictModule.name()).to.equal(
        "CountryRestrictModule"
      );
    });
  });
  ...
  describe(".isPlugAndPlay()", () => {
    it("should return true", async () => {
      const context = await loadFixture(
        deployComplianceWithCountryRestrictModule
      );
      expect(await context.suite.countryRestrictModule.isPlugAndPlay()).to.be
        .true;
    });
  });
  ...
  describe(".canComplianceBind()", () => {
    it("should return true", async () => {
      ...
      expect(
        await context.suite.countryRestrictModule.canComplianceBind(
  ...
  describe(".owner", () => {
    it("should return owner", async () => {
      ...
      await expect(
        context.suite.countryRestrictModule.owner()
  ...
  describe(".transferOwnership", () => {
    ...
    describe("when calling with owner account", () => {
      it("should transfer ownership", async () => {
        ...
        const tx2 = await context.suite.countryRestrictModule
  ...
  describe(".batchRestrictCountries()", () => {
    ...
    describe("when called via the compliance", () => {
      ...
      it("should add the country restriction", async () => {
        ...
        expect(
          await countryRestrictModule.isCountryRestricted(compliance.target, 42)
        ).to.be.true;
        expect(
          await countryRestrictModule.isCountryRestricted(compliance.target, 66)
        ).to.be.true;
      });
    });
  });
  ...
  describe(".supportsInterface()", () => {
    it("should return false for unsupported interfaces", async () => {
      ...
      expect(
        await countryRestrictModule.supportsInterface(unsupportedInterfaceId)
      ).to.equal(false);
    });
    ...
    it("should correctly identify the IModule interface ID", async () => {
      ...
      expect(
        await countryRestrictModule.supportsInterface(iModuleInterfaceId)
      ).to.equal(true);
    });
    ...
    it("should correctly identify the IERC173 interface ID", async () => {
      ...
      expect(
        await countryRestrictModule.supportsInterface(ierc173InterfaceId)
      ).to.equal(true);
    });
    ...
    it("should correctly identify the IERC165 interface ID", async () => {
      ...
      expect(
        await countryRestrictModule.supportsInterface(ierc165InterfaceId)
      ).to.equal(true);
    });
  });
  ...
  describe(".unbindCompliance()", () => {
    it("should unbind the compliance", async () => {
      const {
        suite: { countryRestrictModule: module, compliance },
        accounts: { deployer },
      } = await loadFixture(deployComplianceWithCountryRestrictModule);
      ...
      expect(
        await module.isCountryRestricted(compliance.target, 42)
      ).to.be.equal(false);
    });
  });
});
