    ...
    describe('when calling via the compliance contract', () => {
      describe('when country is already allowed', () => {
        it('should revert', async () => {
          ...
          ).to.be.revertedWithCustomError(countryAllowModule, 'CountryAlreadyAllowed').withArgs(compliance.address, 42);
        });
      });
    ...
    describe('when calling via the compliance contract', () => {
      describe('when country is not allowed', () => {
        it('should revert', async () => {
          ...
          ).to.be.revertedWithCustomError(countryAllowModule, 'CountryNotAllowed').withArgs(compliance.address, 42);
        });
      });
