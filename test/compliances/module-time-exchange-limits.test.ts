...
describe("Compliance Module: TimeExchangeLimits", () => {
  it("should deploy the TimeExchangeLimits contract and bind it to the compliance", async () => {
    ...
    expect(
      await context.contracts.compliance.isModuleBound(
  ...
  describe(".name()", () => {
    it("should return the name of the module", async () => {
      ...
      expect(await context.contracts.complianceModule.name()).to.be.equal(
        "TimeExchangeLimitsModule"
      );
    });
  });
  ...
  describe(".owner", () => {
    it("should return owner", async () => {
      const context = await loadFixture(deployTimeExchangeLimitsFixture);
      await expect(
        context.contracts.complianceModule.owner()
  ...
  describe(".initialize", () => {
    it("should be called only once", async () => {
      ...
      const module = (
        await ethers.deployContract("TimeExchangeLimitsModule")
      ).connect(deployer);
  ...
  describe(".transferOwnership", () => {
    ...
    describe("when calling with owner account", () => {
      it("should transfer ownership", async () => {
        ...
        // when
        const tx1 = await context.contracts.complianceModule
        ...
        const tx2 = await context.contracts.complianceModule
  ...
  describe(".setExchangeLimit", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.contracts.complianceModule.setExchangeLimit(exchangeID, {
            limitTime: 1,
            limitValue: 100,
          })
        ).to.revertedWithCustomError(
        ...
        describe("when limit array size not exceeded", () => {
          it("should add new limit", async () => {
            ...
            const tx = await context.contracts.compliance.callModuleFunction(
              ...
              ]).encodeFunctionData("setExchangeLimit", [
                exchangeID,
            ...
            await expect(tx)
              ...
              .withArgs(
                context.contracts.compliance.target,
                exchangeID,
                100,
                1
              );
            ...
            const limits =
              await context.contracts.complianceModule.getExchangeLimits(
  ...
  describe(".getExchangeCounter", () => {
    it("should return counter", async () => {
      ...
      await (
        context.suite.complianceModule.connect(
      ...
      await context.suite.compliance.callModuleFunction(
        new ethers.Interface([
          ...
          exchangeID,
          { limitTime: 10000, limitValue: 100 },
        ]),
    ...
    describe("when calling with owner", () => {
      describe("when exchangeID is not tagged", () => {
        it("should tag ONCHAINID as exchange", async () => {
          ...
          await expect(tx)
            .to.emit(context.contracts.complianceModule, "ExchangeIDAdded")
            .withArgs(exchangeID);
          expect(
            await context.contracts.complianceModule.isExchangeID(exchangeID)
          ).to.be.true;
        });
      });
    ...
    describe("when calling via compliance", () => {
      describe("when exchangeID is tagged", () => {
        it("should untag the exchangeID", async () => {
          ...
          await expect(tx)
            .to.emit(context.contracts.complianceModule, "ExchangeIDRemoved")
            .withArgs(exchangeID);
          expect(
            await context.contracts.complianceModule.isExchangeID(exchangeID)
          ).to.be.false;
  ...
  describe(".moduleTransferAction", () => {
    describe("when calling directly", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.contracts.complianceModule.moduleTransferAction(from, to, 10)
        ).to.revertedWithCustomError(
          context.contracts.complianceModule,
          "OnlyBoundComplianceCanCall"
        );
          ...
          describe("when the exchange limit is not exceeded", () => {
            it("should increase exchange counter", async () => {
              const context = await loadFixture(
                deployTimeExchangeLimitsFullSuite
              );
              const from = context.accounts.aliceWallet.address;
              const to = context.accounts.bobWallet.address;
              const exchangeID =
                await context.suite.identityRegistry.identity(to);
              const investorID =
                await context.suite.identityRegistry.identity(from);
              ...
              const counter =
                await context.suite.complianceModule.getExchangeCounter(
                  context.suite.compliance.target,
                  exchangeID,
                  investorID,
                  10000
  ...
  describe(".canComplianceBind", () => {
    it("should return true", async () => {
      const context = await loadFixture(deployTimeExchangeLimitsFullSuite);
      expect(
        await context.suite.complianceModule.canComplianceBind(
          context.suite.compliance.target
        )
      ).to.be.true;
    });
    ...
    describe("when receiver is exchange", () => {
      describe("when sender is exchange", () => {
        it("should return true", async () => {
          ...
          const from = context.accounts.aliceWallet.address;
          const to = context.accounts.bobWallet.address;
          const senderExchangeID =
            await context.suite.identityRegistry.identity(from);
          const receiverExchangeID =
            await context.suite.identityRegistry.identity(to);
        ...
        it("should return true", async () => {
          ...
          await context.suite.compliance.callModuleFunction(
            new ethers.Interface([
              ...
              exchangeID,
              { limitTime: 10000, limitValue: 150 },
            ]),
            context.suite.complianceModule.target
          );
  ...
  describe(".moduleMintAction", () => {
    describe("when calling from a random wallet", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.contracts.complianceModule.moduleMintAction(
  ...
  describe(".moduleBurnAction", () => {
    describe("when calling from a random wallet", () => {
      it("should revert", async () => {
        ...
        await expect(
          context.contracts.complianceModule.moduleBurnAction(
            context.accounts.anotherWallet.address,
            10
          )
        ).to.be.revertedWithCustomError(
  ...
  describe(".supportsInterface()", () => {
    it("should return false for unsupported interfaces", async () => {
      ...
      expect(
        await context.contracts.complianceModule.supportsInterface(
  ...
  describe(".unbindCompliance()", () => {
    it("should unbind the compliance", async () => {
      ...
      const limits = await module.getExchangeLimits(
        compliance.target,
        exchangeID
      );
